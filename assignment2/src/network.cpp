...
void Network::_ready(){
    ...
    get_tree()->connect("network_peer_connected", this, "_onplayer_connected");
}


void Network::create_server(String playerNickname)
{
    Godot::print("we are creating a new network");
...
{
    Godot::print("we are sending the player information");
    players[id] = info;
